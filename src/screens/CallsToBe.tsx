...
import { Search, Settings, X, Grid3x3, Play, ArrowLeft, MoreHorizontal, ThumbsUp, ThumbsDown, Bell, FileText } from 'lucide-react'
...
const CALL_LOG: { date: string; calls: CallEntry[] }[] = [
  ...
  },
  {
    ...
    calls: [
      ...
      { id: '12', name: '+7 989 777 88 11', callType: 'blocked', typeLabel: 'Заблокировал Защитник', time: '17:33' },
      ...
      <div className="w-full max-w-app flex flex-col min-h-screen">
        ...
        <div className="px-4 pt-12 pb-3 bg-white border-b border-gray-100 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setShowShare(true)} className="w-9 h-9 flex items-center justify-center shrink-0 rounded-xl" style={{ background: '#E8F2FF' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0070E5" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/>
              </svg>
            </button>
              ...
              <motion.div className="relative w-full max-w-app bg-white rounded-t-[24px] overflow-hidden" initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }} transition={{ type: 'spring', damping: 28, stiffness: 300 }}>
                ...
                <div className="px-5 pt-3 pb-10">
                  <div className="flex items-center justify-between mb-4">
                    <p className="font-sans font-bold text-base text-gray-900">Поделиться</p>
                    <button onClick={() => setShowShare(false)} className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100">
                      <X size={14} className="text-gray-500" strokeWidth={2}/>
                    </button>
                  </div>
                  <div className="flex flex-col gap-2">
                    <button className="w-full flex items-center gap-4 px-4 py-3.5 bg-gray-50 rounded-2xl active:bg-gray-100 transition-colors">
                      <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shrink-0" style={{ boxShadow: '0 1px 6px rgba(0,0,0,0.1)' }}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="5" cy="7" r="4" stroke="#9CA3AF" strokeWidth="2"/><circle cx="15" cy="7" r="4" stroke="#9CA3AF" strokeWidth="2"/><line x1="5" y1="11" x2="15" y2="11" stroke="#9CA3AF" strokeWidth="2"/></svg>
                      </div>
                      <span className="font-sans font-semibold text-base text-gray-900">Записью</span>
                    </button>
                    <button className="w-full flex items-center gap-4 px-4 py-3.5 bg-gray-50 rounded-2xl active:bg-gray-100 transition-colors">
                      <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shrink-0" style={{ boxShadow: '0 1px 6px rgba(0,0,0,0.1)' }}>
                        <FileText size={18} className="text-blue-500" strokeWidth={1.8}/>
                      </div>
                      <span className="font-sans font-semibold text-base text-gray-900">Расшифровкой</span>
                    </button>
                  </div>
                </div>
              </motion.div>
        ...
        >
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <button className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: 'rgba(29,32,35,0.07)' }}>
